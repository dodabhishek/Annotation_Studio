import { MousePointer2, Square, Pentagon, Spline, Circle, Hand, ZoomIn, ZoomOut, RotateCcw, Download, Trash2, ChevronLeft, ChevronRight, } from 'lucide-react';
...
export function Toolbar({ selectedTool, onSelectTool, zoom, onZoomIn, onZoomOut, onResetView, onDeleteSelected, onExport, hasSelectedAnnotation, canGoNext, canGoPrev, onNext, onPrev, currentIndex, totalImages, }) {
