...
export function AnnotationCanvas({
  ...
  const handleMouseDown = useCallback(
    ...
    [image, selectedTool, selectedLabelId, annotations, currentPoints, getImageCoordinates, onAddAnnotation, onSelectAnnotation]
  );
  ...
  const handleMouseMove = useCallback(
    ...
    [selectedTool, getImageCoordinates, onPanChange, pan]
  );
